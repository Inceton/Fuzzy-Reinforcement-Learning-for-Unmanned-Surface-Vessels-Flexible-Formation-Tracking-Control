...
def plot_tracking(pos, ref):
    ...
    if switch == 1:
        plt.savefig(f'usv_track_fls_n={n}.pdf', dpi=300, bbox_inches='tight')
    elif switch == 2:
        plt.savefig(f'usv_track_smo.pdf', dpi=300, bbox_inches='tight')
    elif switch == 3:
        plt.savefig(f'usv_track_backstepping.pdf', dpi=300, bbox_inches='tight')
    elif switch == 4:
        plt.savefig(f'usv_track_pid.pdf', dpi=300, bbox_inches='tight')
...
def plot_speed(v):
    ...
    plt.legend(prop={'size': 10}, frameon=False, loc='upper right', bbox_to_anchor=(1, 1), handlelength=1.5)
    if switch == 1:
        plt.savefig(f'usv_speed_fls_n={n}.pdf', dpi=300, bbox_inches='tight')
    elif switch == 2:
        plt.savefig(f'usv_speed_smo.pdf', dpi=300, bbox_inches='tight')
    elif switch == 3:
        plt.savefig(f'usv_speed_backstepping.pdf', dpi=300, bbox_inches='tight')
    elif switch == 4:
        plt.savefig(f'usv_speed_pid.pdf', dpi=300, bbox_inches='tight')
...
def plot_xgap(x):
    ...
    plt.xlabel('Times (s)', fontsize=12)
    plt.ylabel('X-gap between USVs (m)', fontsize=12)
    plt.xticks(fontsize=10)
    plt.yticks(fontsize=10)
    ax.grid(True, color='lightgrey', linestyle='--', linewidth=0.5)
    plt.legend(prop={'size': 10}, frameon=False, loc='upper right', bbox_to_anchor=(1, 1), handlelength=1.5)
    plt.tight_layout()
    if switch == 1:
        plt.savefig(f'usv_xgap_fls_n={n}.pdf', dpi=300, bbox_inches='tight')
    elif switch == 2:
        plt.savefig(f'usv_xgap_smo.pdf', dpi=300, bbox_inches='tight')
    elif switch == 3:
        plt.savefig(f'usv_xgap_backstepping.pdf', dpi=300, bbox_inches='tight')
    elif switch == 4:
        plt.savefig(f'usv_xgap_pid.pdf', dpi=300, bbox_inches='tight')
...
def plot_ygap(y):
    ...
    plt.tight_layout()
    if switch == 1:
        plt.savefig(f'usv_ygap_fls_n={n}.pdf', dpi=300, bbox_inches='tight')
    elif switch == 2:
        plt.savefig(f'usv_ygap_smo.pdf', dpi=300, bbox_inches='tight')
    elif switch == 3:
        plt.savefig(f'usv_ygap_backstepping.pdf', dpi=300, bbox_inches='tight')
    elif switch == 4:
        plt.savefig(f'usv_ygap_pid.pdf', dpi=300, bbox_inches='tight')
...
def plot_error(e1, e2):
    ...
    plt.tight_layout()
    if switch == 1:
        plt.savefig(f'usv_error_fls_n={n}.pdf', dpi=300, bbox_inches='tight')
    elif switch == 2:
        plt.savefig(f'usv_error_smo.pdf', dpi=300, bbox_inches='tight')
    elif switch == 3:
        plt.savefig(f'usv_error_backstepping.pdf', dpi=300, bbox_inches='tight')
    elif switch == 4:
        plt.savefig(f'usv_error_pid.pdf', dpi=300, bbox_inches='tight')
...
def plot_error_all():
    ...
    plt.plot(df['1'], color=colors[0], label='Proposed Control Scheme')
    plt.plot(df['2'], color=colors[2], label='SMO Observer Method')
    plt.plot(df['3'], color=colors[4], label='Backstepping Control Approach')
    plt.xlabel('Times (s)', fontsize=12)
    plt.ylabel('Tracking error of different schemes of USV1 (m)', fontsize=12)
    ax.grid(True, color='lightgrey', linestyle='--', linewidth=0.5)
    plt.legend(prop={'size': 10}, frameon=False, loc='upper right', bbox_to_anchor=(1, 1), handlelength=1.5)
    plt.tight_layout()
    plt.savefig(f'tracking_error.pdf', dpi=300, bbox_inches='tight')
